...
<TASK>
   ...
   5. Domain Language
      - Read `GLOSSARY.md` if it exists. Format reference: fetch https://github.com/mmadariaga/prompts/blob/main/instructions/glossary-format.md to interpret the file structure (Language, Relationships, Example dialogue, Flagged ambiguities).
