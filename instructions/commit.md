...
<TASK>
    ...
    **Footer (optional):**
    ...
    - **Language:** Respond to the user in the same language they write in. Commit messages themselves are written in English unless the repo's recent history clearly uses another language.
